<html>
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/670.less', 'css/670.css');
        ?>
        <link href="css/670.css" rel="stylesheet" type="text/css"/>
                ...
                <div class="content no_shadow">
                    ...
                    <div class="slidebar-1">
                        ...
                        <div class="tab-content">
                            ...
                            <menu id="menu1" class="tab-pane fade">
                                <div class="eq_grid post_eq_grid rh-flex-eq-height col_wrap_three">
                                    <article class="col_item offer_grid offer_grid_com offer_act_enabled">
                                        <div class="info_in_dealgrid">
                                            <figure>
                            ...
                            <menu id="menu2" class="tab-pane fade">
                                <div class="eq_grid post_eq_grid rh-flex-eq-height col_wrap_three">
                                    <article class="col_item offer_grid offer_grid_com offer_act_enabled">
                                        <div class="info_in_dealgrid">
                                            <figure>
                            ...
                            <menu id="menu3" class="tab-pane fade">
                                <div class="eq_grid post_eq_grid rh-flex-eq-height col_wrap_three">
                                    <article class="col_item offer_grid offer_grid_com offer_act_enabled">
                                        <div class="info_in_dealgrid">
                                            <figure>
