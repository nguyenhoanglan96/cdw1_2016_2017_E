<?php
$root_url = 'http://localhost:8080/trangchu/Home.php';
...
if (!empty($id)) {
    $url =  'http://localhost:8080/trangchu/Home.php';

    $url_less = 'http://localhost:8080/trangchu/less/styles.less';
    $url_bootsrap = 'http://localhost:8080/trangchu/css/bootstrap.min.css';
    $url_awesome =  'http://localhost:8080/trangchu/css/font-awesome.min.css';
