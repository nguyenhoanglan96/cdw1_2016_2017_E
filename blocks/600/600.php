...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/600.less', 'css/600.css');
        ?>
                            ...
                            <div class="screenshot-box kl-style-2">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="left-side">
                                            <!-- Title -->
                                            <h3 class="title"><span >This is Kallyas Template, a rich featured, epic, <span class="fw-semibold">mature and premium work.</span></span></h3>
                                            <!--/ Title -->
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="thescreenshot">
                                            ...
                                            <div style="display: block; text-align: start; float: none; position: relative; top: auto; right: auto; bottom: auto; left: auto; z-index: auto; width: 555px; height: 364px; margin: 0px; overflow: hidden;"><ul class="screenshot-carousel" data-carousel-pagination="." style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 3885px; height: 364px; z-index: 1; opacity: 0.160944;">
                                                    <!-- Slide 1 -->
                                                    ...
                                                    </li></ul><ul class="screenshot-carousel" data-carousel-pagination="." style="text-align: left; float: none; position: absolute; top: 0px; right: auto; bottom: auto; left: 0px; margin: 0px; width: 3885px; height: 364px; z-index: 0; opacity: 0.839056;">
                                                    <!-- Slide 1 -->
                                            ...
                                            <!-- pagination -->
                                            <div style="display: block;"><a href="#" ><span>1</span></a><a href="#" ><span>2</span></a><a href="#" ><span>3</span></a></div>
                                            <!--/ pagination -->
                                        </div>
                                        <!-- thescreenshot image carousel -->
                                    </div>
