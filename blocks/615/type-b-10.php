...
<html style="background-color: #f3f3f4;">
    ...
    <div class="type-b-10">
            ...
            <section class="relative ptop-65" style="background-color: #cc2e2e;">
                <div class="source">
                    ...
                    <div class="row">
                        <div class="col-sm-offset-2 col-md-8 col-sm-8">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="kl-iconbox kl-iconbox--align-center text-center ">
                                            <div class="content-wrapper">
                                                <div class="desc-wrapper kl-iconbox__desc-wrapper">
                ...
                <div class="bottommask bottommask-mask3">
