...
<head>
    ...
    <?php
        ...
        $less = new lessc;
        $less->compileFile('less/639.less', 'css/639.css');
        ?>

        <link href="css/639.css" rel="stylesheet" type="text/css" />
</head>
        ...
        <div class="type_footer">
            <footer>
                ...
                <div class="footer">
                    <div class="container">
                        <!-- Prefooter Section -->
                        <section class="row pre-footer eq-columns">
                            <div class="widget col-md-4 col-sm-12 col-xs-6">
                        ...
                        <!-- Footer widgets -->
                        <section class="row widgets footer-widgets">
                            ...
                            <div class="widget  col-md-3 col-sm-6">
                                <div class="newsletter widget">
                                    ...
                                    <form  novalidate="true">
                                        ...
                                        <button type="submit" class=" btn-block">Subscribe Now!</button>
                                    </form>
                                    <p style="display:none;"></p>
                                    <a href="javascript:void(0)" style="display:none;">Try again</a>
                                </div>
                        ...
                        <div class="row copyright-bar">
                            ...
                            <div class="col-md-6">
                                <div class="widget footer-widgets footer-bottom-widgets">
                                    <div >Copyright © 2016 Offshore Industries. All rights reserved.</div>
                                </div>
                            </div>
                            <div class="col-md-6 ">
                                <div class="widget footer-widgets footer-bottom-widgets">
                                ...
                                <div class="widget footer-widgets footer-bottom-widgets">
                                    <div><span> | </span> Made with <i class="fa" aria-hidden="true"></i> by Surjith S M &amp; Gautam Thapar</div>
                                </div>
                            </div>
