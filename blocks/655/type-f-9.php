...
<html>
    ...
    <head>
        ...
        <link href="css/type-f.css" rel="stylesheet" type="text/css" />
        <?php
        if (!class_exists('lessc')) {
            include ('./libs/lessc.inc.php');
        }
        $less = new lessc;
        $less->compileFile('less/type-f.less', 'css/type-f.css');
        ?>
                ...
                <div class="type-f-9">
                    ...
                    <div class="title_container">
                        ...
                        <div class="col-md-4">
                                ...
                                <a href="#"><img src="images/jeff_golden_1-350x350.jpg" alt="Lorem ipsum dolor sit amet, consectetuer adipiscing elit." title="Lorem ipsum dolor sit amet, consectetuer adipiscing elit."></a>
                           
                            <div class="sidebar"><div  class="widget"><h3 class="widgettitle cufon_headings">Widget Ready Areas</h3>			
