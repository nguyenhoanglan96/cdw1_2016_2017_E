...
<html>
    ...
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/type-23-slideshow-footer.less', 'css/type-23-slideshow-footer.css');
        ?>
        <link href="css/type-23-slideshow-footer.css" rel="stylesheet" type="text/css" />
        <link href="css/swiper.min.css" rel="stylesheet" type="text/css" />

    </head>

    <body>
        <div class="type-23-slideshow-footer">
            <div class="slideshow-footer">
                <div class="container content_wrap">
                    <div id="carousel" class="carousel slide carousel-fade content" data-ride="carousel">
                        <!-- Carousel items -->
